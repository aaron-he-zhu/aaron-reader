"""Offline bridge for AI generated by a ChatGPT/Codex subscription task.

The bridge only exports bounded publisher metadata and imports locally
validated JSON.  It never constructs a provider client, reads an API key, or
creates a billable-attempt audit row.
"""
...
SUBSCRIPTION_PROVIDER = "chatgpt-codex-subscription"
...
def export_subscription_batch(
    ...
    *,
    ...
    return {
        ...
        "generation": {
            "surface": "ChatGPT/Codex subscription",
